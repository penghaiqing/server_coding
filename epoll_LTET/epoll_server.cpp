/*
 * @Author: your name
 * @Date: 2021-07-26 07:34:32
 * @LastEditTime: 2021-07-27 06:47:02
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /network_program/server_coding/epoll_LT/epoll_server.cpp
 */
            ...
            if(epoll_events[i].events & EPOLLIN){
                if(epoll_events[i].data.fd == listenfd){
                    ...
                    client_fd_event.events = EPOLLIN;
                     ...
                     client_fd_event.events |= EPOLLET; // 注释掉此行，则用默认的 水平触发模式 ET
